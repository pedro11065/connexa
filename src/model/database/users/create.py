...
def db_create_user(nome, email, senha, curso, periodo, status): # Cria um usuário usando as informações do user_info como parametro, todos os dados são temporários.
